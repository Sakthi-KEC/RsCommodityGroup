package net.microservices.RsCommodityGroup.exception;
...
public class GlobalExceptionHandler
{
    ...
    public ResponseEntity<ErrorDetails> mapException(CustomException e)
    {
    ...
    public ResponseEntity<ErrorDetails> mapException(Exception e)
    {
